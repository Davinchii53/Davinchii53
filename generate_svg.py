...
# Ponytail fix: stacked vertical layout makes width much narrower, saving text readability on mobile
svg_width = 450
font_size = 9
line_height = 11
...
svg_height = right_panel_y + 495 + 40
...
svg_content += f"""
  ...
  <!-- Stacked Panel below the ASCII art -->
  <g transform="translate(20, {right_panel_y})">
